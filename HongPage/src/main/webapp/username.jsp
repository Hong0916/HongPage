...
<head>
	...
	<script type="text/javascript">
		...
		function registerFunction(){
		    registerRequest.open("Post", "./UserRegisterServlet?userID=" + encodeURIComponent(document.getElementById("registerID").value) + 
                    					"&userPassword=" + encodeURIComponent(document.getElementById("registerPassword").value) +
                					    "&userName=" + encodeURIComponent(document.getElementById("registerName").value) +
		                                ...
		                                "&userAge="+ encodeURIComponent(document.getElementById("registerAge").value), true);
		...
		<table class = "table" style="text-align: center; border: 1px solid #dddddd">
			...
			<tbody>
				...
				<tr>
					...
					<td><input class="form-control" type="text" id = "registerPassword" size = "20"></td>
				</tr>
				<tr>
